...
export default async function ShippingAndReturnsPage() {
  ...
  const shippingContent = settings?.shippingAndReturns;
  const showRichContent = hasVisibleContent(shippingContent);
      ...
      <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-12 backdrop-blur-xl text-white shadow-2xl mt-4">
        ...
        {showRichContent ? (
          ...
          <div className="space-y-8 text-white/80 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3">1. Shipping Options & Delivery</h2>
              <p>
                We offer standard and expedited shipping across Pakistan. Orders are processed within 1-2 business days
                and typical delivery times range from 2-5 working days depending on location.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-3">2. Returns & Exchanges Policy</h2>
              <p>
                If you receive a damaged or incorrect item, you can request a return or exchange within 7 days of delivery.
                Items must be unused and in original packaging. Contact our customer support team to initiate a return.
              </p>
            </section>
          </div>
        )}
