...
export default function AquaMistHero() {
  ...
  if (slides.length > 0) {
    return (
      <section className="relative w-full h-[120vw] max-h-[90vh] min-h-[400px] md:h-[calc(100vh-80px)] mt-[80px] overflow-hidden group bg-[#0a0f1e]">
        {slides.map((slide: any, i: number) => {
          ...
          return (
            ...
            >
              ...
              {/* Text Overlay */}
              {showOverlay && (
                <div className="absolute inset-0 flex items-end md:items-center z-[12]">
                  ...
                  <div className="relative z-20 px-6 pb-12 md:px-16 md:pb-0 max-w-2xl">
                    {slide.title && (
